...
Erwin Segal, the player character will be seen in vivid colours, while the rest of the world will completely grayscaled. As the game progresses,
...
Erwin interacts with the NPCs. While Erwin affects the world around him through his actions, Erwin will
...
##### Fuyumi Miyazawa
###### Poetry
In this mini game, you help Fuyumi come up with ideas for her artwork by writing her poems. There are multiple complete poems you can create, but you might not always make it. The game gives you words to choose from, and you must first choose one that you like, and then make the entire poem, the closer you get to one the poems, the better Fuyumi can be inspired from.
##### Elizabeth Hughes
###### Cat Catching
...
### Art
#### Characters
###### Erwin Segal - Main Character
###### Santino Rodriguez - College Student
###### Elizabeth Hughes - Cat Lady
###### Fuyumi(Miyazawa) - Striving Artist
###### Joe Jones - Hoarder
#### Building
#### Bonus
### Code
...
For Milestone goal we will be focusing on getting more mini-games into Neighbor. We realized that the game would be more interesting if we had more mini-games, and will be trying to get to 2-3 minigames per character, on top of that we will be adding a fifth character, this one being a pair. Twins who are haunting the apartment complex, they may be ghosts but they're not evil and simply want to get past whatever is keeping them here. Another goal is to have the narrative part of the game fleshed out and maybe even completed. Neighbor right now has a very basic story, but we believe we can add more to it and make it better. Part of the team will be working on creating the mini-games we design, while another group will be focusing on getting the narrative part of the game done. 
#### Milestone 3 TBA
#### Milestone 4 TBA
